...
const testAppAPI = axios.create({
  baseURL: "https://testapp2121-dev-15121.botics.co/",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_v1_customtext_list(action) {
  return testAppAPI.get(`/api/v1/customtext/`)
}
function api_v1_customtext_read(action) {
  return testAppAPI.get(`/api/v1/customtext/${action.id}/`)
}
function api_v1_customtext_update(action) {
  return testAppAPI.put(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_customtext_partial_update(action) {
  return testAppAPI.patch(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_homepage_list(action) {
  return testAppAPI.get(`/api/v1/homepage/`)
}
function api_v1_homepage_read(action) {
  return testAppAPI.get(`/api/v1/homepage/${action.id}/`)
}
function api_v1_homepage_update(action) {
  return testAppAPI.put(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_homepage_partial_update(action) {
  return testAppAPI.patch(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_signup_create(action) {
  return testAppAPI.post(`/api/v1/signup/`, null, { data: action.data })
}
function rest_auth_login_create(action) {
  return testAppAPI.post(`/rest-auth/login/`, null, { data: action.data })
}
...
function rest_auth_password_change_create(action) {
  return testAppAPI.post(`/rest-auth/password/change/`, null, {
    data: action.data
  })
}
function rest_auth_password_reset_create(action) {
  return testAppAPI.post(`/rest-auth/password/reset/`, null, {
    data: action.data
  })
}
function rest_auth_password_reset_confirm_create(action) {
  return testAppAPI.post(`/rest-auth/password/reset/confirm/`, null, {
    data: action.data
  })
}
function rest_auth_registration_create(action) {
  return testAppAPI.post(`/rest-auth/registration/`, null, {
    data: action.data
  })
}
function rest_auth_registration_verify_email_create(action) {
  return testAppAPI.post(`/rest-auth/registration/verify-email/`, null, {
    data: action.data
  })
}
...
function rest_auth_user_update(action) {
  return testAppAPI.put(`/rest-auth/user/`, null, { data: action.data })
}
function rest_auth_user_partial_update(action) {
  return testAppAPI.patch(`/rest-auth/user/`, null, { data: action.data })
}
